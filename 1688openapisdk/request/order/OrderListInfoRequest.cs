...
namespace _1688openapisdk.domain.order
{
    ...
    public class OrderListInfoRequest : IAliRequest<OrderListInfoResponse>
    {
        ...
        /// <summary>
        /// 订单交易状态，默认为全部交易状态。若值不为空，合法取值列举如下:SUCCESS，CANCEL，WAIT_BUYER_PAY，WAIT_SELLER_SEND，WAIT_BUYER_RECEIVE
        /// </summary>
        ...
        string IAliRequest<OrderListInfoResponse>.GetApiName()
        {
            return "param2/2/cn.alibaba.open/trade.order.orderList.get/";
        }

        IDictionary<string, string> IAliRequest<OrderListInfoResponse>.GetParameters()
        {
        ...
        void IAliRequest<OrderListInfoResponse>.Validate()
        {
        ...
        object IAliRequest<OrderListInfoResponse>.GetReturnType()
        {
